...
s_Hamilt = [1,0.4,1.6],#0.4:0.6:1.6, 
		
b_Hamilt = [1,0.4,1.6],#0.4:0.6:1.6, 
...
#											15000,
		...
		preserved_symmetries = setdiff(["None"; join.(Combinatorics.powerset(["P", "Mx", "Ct", "Tt"],1,2),"+"); "All"], ["Ct+Tt","P+Tt","P+Ct"]),
